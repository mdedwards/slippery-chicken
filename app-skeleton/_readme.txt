...
* The GNU C compiler (gcc), which comes free with Apple's developer tools
  (https://developer.apple.com/technologies/tools/). NB You'll need to download
  and install the X-code Command Line Tools and then verify that gcc works by
  opening the terminal app and typing gcc -v (whereupon you should see version
