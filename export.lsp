...
;;;
;;; Purpose:          Symbol package exports.
;;;
;;; Author:           Michael Edwards: m@michael-edwards.org
;;;
;;; Creation date:    28th March 2013.
;;;
;;; $$ Last modified: 11:03:14 Thu Mar 28 2013 GMT
;;;
;;; SVN ID: $Id$
;;;
;;; ****
...
(export 
 '( 
   ...
   interpolate invert-pitch-list is-dynamic
   ...
   add-event-to-bar add-inversions add-mark add-mark add-mark
   ...
   sc-remove-dynamic sc-remove-dynamics sc-subseq scale scale scale scale scale
   scale sclist-econs sclist-remove-elements scm-get-data set-8va
   set-amplitudes set-cautionary-accidental set-characteristic set-data
   set-data set-dynamics set-map-refs set-midi-channel set-midi-channel
   set-midi-channel set-midi-channel set-midi-time-sig set-nth set-nth-attack
   set-nth-attack set-nth-bar set-nth-of-data set-position set-prefers-high
   set-prefers-high set-prefers-low set-prefers-low set-rehearsal-letter
   set-slot set-written set-written sharp-p shorten-large-fast-leaps
   sort-pitches split split split stack stack statistics stereo subset-get-srts
   subtract
